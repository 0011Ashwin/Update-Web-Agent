...
def create_agent_settings_tab(webui_manager: WebuiManager):
    ...
    with gr.Group():
        gr.Markdown("### 🗣️ Eleven Labs Settings")
        eleven_labs_api_key = gr.Textbox(
            label="Eleven Labs API Key",
            type="password",
            value=os.getenv("ELEVEN_LABS_API_KEY", ""),
            info="Your Eleven Labs API key (leave blank to use .env)",
            interactive=True
        )
        eleven_labs_voice_id = gr.Textbox(
            label="Eleven Labs Voice ID",
            value=os.getenv("ELEVEN_LABS_VOICE_ID", ""),
            info="The Voice ID to use for text-to-speech (leave blank for default)",
            interactive=True
        )

        eleven_labs_language = gr.Dropdown(
            label="Eleven Labs Language",
            choices=["English", "Hindi"],
            value="English",
            info="Select the language for text-to-speech",
            interactive=True
        )
